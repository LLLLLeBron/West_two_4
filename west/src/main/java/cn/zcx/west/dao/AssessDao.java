  ...
  public boolean insert(Assess assess)
  {
    if(tableJudgment("assess"))       //判断表是否存在
    {
      ...
      try
      {
        ...
        preparedStatement.setTimestamp(4, new java.sql.Timestamp(assess.getDeadline().getTime()));
  ...
  public boolean update(Assess assess)
  {
    if(tableJudgment("assess"))       //判断表是否存在
    {
      ...
      try
      {
        ...
        preparedStatement.setTimestamp(3, new java.sql.Timestamp(assess.getDeadline().getTime()));
    ...
    if(tableJudgment("assess"))       //判断表是否存在
    {
      ...
      try
      {
        ...
        while (resultSet.next())//遍历
        {
          ...
          java.util.Date date = new Date(resultSet.getTimestamp("截止时间").getTime());
